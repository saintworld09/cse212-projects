...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue inserted new people at the front of the queue
    // instead of the back, causing the queue to behave incorrectly and return people in the wrong order.
    ...
    // Defect(s) Found: PersonQueue.Enqueue inserted new people at the front of the queue
    // instead of the back, causing the newly added person to be processed before people already in the queue.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: PersonQueue.Enqueue inserted new people at the front of the queue
    // instead of the back, causing the circular queue to return people in the wrong order.
    ...
    // Defect(s) Found: No defect found. The test passed as expected.
